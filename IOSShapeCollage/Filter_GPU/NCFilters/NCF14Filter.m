...
NSString *const kNCF14ShaderString = SHADER_STRING
(
...
@implementation NCF14Filter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCF14ShaderString]))
    {
		return nil;
    }
