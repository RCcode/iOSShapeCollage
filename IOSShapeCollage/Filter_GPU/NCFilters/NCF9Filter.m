...
NSString *const kNCF9ShaderString = SHADER_STRING
(
 ...
 uniform sampler2D inputImageTexture2; //F9Metal
 uniform sampler2D inputImageTexture3; //F9Softlight
 uniform sampler2D inputImageTexture4; //F9Curves
 uniform sampler2D inputImageTexture5; //F9OverlayMapWarm
 uniform sampler2D inputImageTexture6; //F9Colorshift
...
@implementation NCF9Filter

- (id)init;
{
    if (!(self = [super initWithFragmentShaderFromString:kNCF9ShaderString]))
    {
		return nil;
    }
