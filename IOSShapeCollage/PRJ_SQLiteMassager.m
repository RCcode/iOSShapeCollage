...
//        //        NSLog(@"1111111");
//        
//        for (FONT_photoMarkObject *photoMark in photoMarkArray) {
...
//                FONT_photoMarkObject* sqlChat = [[FONT_photoMarkObject alloc] init] ;
//                
...
- (BOOL)deleteAllTypeFace
{
    if ([self openDB]) {
        ...
        char *sql = "delete * from typeFaceTable";
...
//            NSLog(@"............");
//            while (sqlite3_step(statement) == SQLITE_ROW) {
//                FONT_photoMarkObject* photoMark = [[FONT_photoMarkObject alloc] init];
//                
